...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_image_0 = n.advertise<sensor_msgs::Image>("image_0", 1000);
...
void pubImage0(const cv::Mat &img0, const double t) {
    std_msgs::Header header;
    header.frame_id = "world";
    header.stamp = ros::Time(t);
    sensor_msgs::ImagePtr img0Msg = cv_bridge::CvImage(header, "mono8", img0).toImageMsg();
    pub_image_0.publish(img0Msg);
}
