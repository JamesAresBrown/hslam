...
#include "../../thirdParty/tinycthread/tinycthread.h"
#include "../../thirdParty/tinycthread/rwmutex.h"
...
class CfindMatch {
 public:
  ...
  // If patches are pdense or not, that is, if we use check(patch) after patch optimization
  int m_depth;
