...
/** \class Ref
  ...
  * By default, a Ref<VectorXf> can reference any pdense vector expression of float having a contiguous memory layout.
  * Likewise, a Ref<MatrixXf> can reference any column major pdense matrix expression of float whose column's elements are contiguously stored with
