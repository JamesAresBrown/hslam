...
// The generic default implementation for pdense block simplu forward to the internal::BlockImpl_dense
...
/** \internal Internal implementation of pdense Blocks in the general case. */
...
/** \internal Internal implementation of pdense Blocks in the direct access case.*/
template<typename XprType, int BlockRows, int BlockCols, bool InnerPanel>
