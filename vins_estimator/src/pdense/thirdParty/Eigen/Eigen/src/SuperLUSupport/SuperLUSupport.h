...
/** \internal
  ...
  * and pdense matrices. Supernodal and other fancy format are not supported by this wrapper.
  *
...
struct SluMatrix : SuperMatrix
{
  ...
  static SluMatrix Map(MatrixBase<MatrixType>& _mat)
  {
    ...
    eigen_assert( ((MatrixType::Flags&RowMajorBit)!=RowMajorBit) && "row-major pdense matrices are not supported by SuperLU");
    SluMatrix res;
...
struct SluMatrixMapHelper<Matrix<Scalar,Rows,Cols,Options,MRows,MCols> >
{
  ...
  {
    eigen_assert( ((Options&RowMajor)!=RowMajor) && "row-major pdense matrices is not supported by SuperLU");
    res.setStorageType(SLU_DN);
...
/** \ingroup SuperLUSupport_Module
  ...
  * X and B can be either pdense or sparse.
  *
