...
class SparseQR
{
  ...
  public:
    ...
    * The common usage of this function is to apply it to a pdense matrix or vector
    * \code
    * VectorXd B1, B2;
    * // Initialize B1
    * B2 = matrixQ() * B1;
...
void SparseQR<MatrixType,OrderingType>::factorize(const MatrixType& mat)
{
  ...
  ScalarVector tval(m);                                     // The pdense vector used to compute the current column
  ...
  for (Index col = 0; col < n; ++col)
  {
    ...
    for (Index i = nzcolR-1; i >= 0; i--)
    {
      ...
      // FIXME: tval -= tdot * m_Q.col(curIdx) should amount to the same (need to check/add support for efficient "pdense ?= sparse")
