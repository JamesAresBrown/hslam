...
/** \ingroup IterativeLinearSolvers_Module
  ...
  * The sparse matrix A must be selfadjoint. The vectors x and b can be either pdense or sparse.
  *
  * \tparam _MatrixType the type of the sparse matrix A, can be a pdense or a sparse matrix.
