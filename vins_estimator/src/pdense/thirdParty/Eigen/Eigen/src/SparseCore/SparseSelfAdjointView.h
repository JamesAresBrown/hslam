...
/** \ingroup SparseCore_Module
  ...
  *
  * \param MatrixType the type of the pdense matrix storing the coefficients
  * \param UpLo can be either \c #Lower or \c #Upper
  *
  * This class is an expression of a sefladjoint matrix from a triangular part of a matrix
  * with given pdense storage of the coefficients. It is the return type of MatrixBase::selfadjointView()
  ...
  : public EigenBase<SparseSelfAdjointView<MatrixType,UpLo> >
{
  public:
    ...
    /** Efficient sparse self-adjoint matrix times pdense vector/matrix product */
    template<typename OtherDerived>
    ...
    /** Efficient pdense vector/matrix times sparse self-adjoint matrix product */
    template<typename OtherDerived> friend
...
/***************************************************************************
* Implementation of sparse self-adjoint time pdense matrix
***************************************************************************/
